...
resource "aws_autoscaling_group" "main" {
  ...
  vpc_zone_identifier = var.subnet_ids        #subnet ids of app subnet is coming in the name of vpc_zone_identifier
  desired_capacity    = var.desired_capacity
  max_size            = var.max_size
  min_size            = var.min_size
  target_group_arns   = [aws_lb_target_group.main.arn]   #For attaching the Target groups to the Autoscaling group
...
#    }
  condition {
    host_header {
      values = [var.component == "frontend" ? "${var.env}.prashdevops.online" : "${var.component}-${var.env}.prashdevops.online.online"]
    }
